...
**_Ожидаемый результат:_** под полем "CVC/CVV" появляется предупреждение "Неверный формат", запрос на сервер не отправляется.
...
👩‍💻 2.3.2 Неверный формат числа в поле "Год" - истёк срок действия.
...
- **_Ожидаемый результат:_**
    - под полем "Владелец" появляется предупреждение "Неверный формат"; запрос на сервер не отправляется.
...
👩‍💻 2.5.1 Неверный формат числа в поле "CVC/CVV".
